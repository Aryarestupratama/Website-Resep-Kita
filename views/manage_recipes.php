...
<title>Kelola Resep - Resep Kita</title>
...
<div class="admin-sidebar">
    ...
    <a href="manage_recipes.php" class="text-mustard" style="opacity:1;">Kelola Resep</a>
...
<div class="admin-main">
    <div class="max-w-4xl mx-auto">
        ...
        <h2 class="font-display text-2xl md:text-3xl font-semibold text-center mt-1 mb-6">Daftar Resep</h2>
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="bg-navy text-white uppercase text-xs tracking-widest">
                        ...
                        <th class="text-left px-4 py-3">Langkah</th>
                ...
                <tbody>
                    <?php foreach ($recipes as $recipe): ?>
                        <tr class="border-b border-navy/10">
                            <td class="px-4 py-3 font-semibold"><?php echo htmlspecialchars($recipe['title']); ?></td>
                            <td class="px-4 py-3 text-navy/70 max-w-xs truncate"><?php echo htmlspecialchars($recipe['ingredients']); ?></td>
                            <td class="px-4 py-3 text-navy/70 max-w-xs truncate"><?php echo htmlspecialchars($recipe['steps']); ?></td>
                            <td class="px-4 py-3"><img src="<?php echo htmlspecialchars($recipe['image_url']); ?>" alt="Gambar Resep" class="rounded-md w-24 h-16 object-cover"></td>
                            <td class="px-4 py-3">
